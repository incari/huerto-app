          ...
          <div className="bg-muted rounded-lg p-3">
            ...
            {config.method === "parades-crestall" && (
              <p className="text-xs text-muted-foreground">
                El método Parades en Crestall utiliza bancales elevados con
                líneas de goteo separadas 30cm. Ideal para huertos urbanos y
                cultivo intensivo.
              </p>
            )}
            {config.method === "traditional" && (
              <p className="text-xs text-muted-foreground">
                Método tradicional con surcos más espaciados (50cm) para
                facilitar el paso y el mantenimiento.
              </p>
            )}
